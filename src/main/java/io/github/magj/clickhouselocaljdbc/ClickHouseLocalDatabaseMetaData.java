...
public class ClickHouseLocalDatabaseMetaData implements DatabaseMetaData {

    private final ClickHouseLocalConnection connection;

    public ClickHouseLocalDatabaseMetaData(ClickHouseLocalConnection connection) {
    ...
    public String getDriverName() throws SQLException {
        return "ClickHouse Local JDBC Driver";
    }
